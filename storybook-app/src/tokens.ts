...
export const semantic = {
  ...
  textPrimary: 'var(--zd-text-primary)',
  textPrimarySubtle: 'var(--zd-text-primary-subtle)',
  textSecondary: 'var(--zd-text-secondary)',
  textTertiary: 'var(--zd-text-tertiary)',
  textDisabled: 'var(--zd-text-disabled)',
  textDisabledLight: 'var(--zd-text-disabled-light)',
  textMuted: 'var(--zd-text-muted)',
  textLight: 'var(--zd-text-light)',
  textOnSurfaceBold: 'var(--zd-text-on-surface-bold)',
  textOnSurfaceSubtle: 'var(--zd-text-on-surface-subtle)',
  textBrandPrimary: 'var(--zd-text-brand-primary)',
  textBrandPrimarySubtle: 'var(--zd-text-brand-primary-subtle)',
  textBrandSecondary: 'var(--zd-text-brand-secondary)',
  textBrandSecondarySubtle: 'var(--zd-text-brand-secondary-subtle)',
  textSuccessBold: 'var(--zd-text-success-bold)',
  textSuccessSubtle: 'var(--zd-text-success-subtle)',
  textSuccessInverted: 'var(--zd-text-success-inverted)',
  textWarningBold: 'var(--zd-text-warning-bold)',
  textWarningSubtle: 'var(--zd-text-warning-subtle)',
  textErrorBold: 'var(--zd-text-error-bold)',
  textErrorSubtle: 'var(--zd-text-error-subtle)',
  textHighlightBold: 'var(--zd-text-highlight-bold)',
  textHighlightSubtle: 'var(--zd-text-highlight-subtle)',
  textAccentBold: 'var(--zd-text-accent-bold)',
  textAccentSubtle: 'var(--zd-text-accent-subtle)',
  textSuperSaver: 'var(--zd-text-super-saver)',
